...
import com.mycompany.web.services.hw3.authenticate.Person;
...
public class PersonFacadeREST extends AbstractFacade<Person> {
    @PersistenceContext(unitName = "com.mycompany_Web-Services-hw3-Authenticate_war_1.0-SNAPSHOTPU")
    ...
    @Consumes({MediaType.APPLICATION_JSON})
    public String loggout(@PathParam("username")String username){
        Person person = em.find(Person.class, username);
        if(person != null & person.getLoogin().equals("1")){
            person.setLoogin("0");
            return "true";
        }
